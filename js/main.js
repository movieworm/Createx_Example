...
const portfolioSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](portSlider, {
  slidesPerView: 3,
  spaceBetween: 30,
  // loop: true,
  navigation: {
  ...
  on: {
    init: function () {
      ...
      const afterNextActiveSlide = nextActiveSlide.nextElementSibling;
      activeSlide.classList.add('slider-visible');
      nextActiveSlide.classList.add('slider-visible');
      afterNextActiveSlide.classList.add('slider-visible');
    }
  }
});
